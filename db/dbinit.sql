...
member_id int(11) auto_increment not null primary key,
...
esa_id int(11) auto_increment not null primary key,
...
ebs_id int(11) auto_increment not null primary key,
member_id int(11) not null,
submitted_date date,
start_date date,
confirmed_date date,
