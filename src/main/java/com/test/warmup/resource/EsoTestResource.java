package com.test.warmup.resource;
...
import com.test.warmup.model.LoginCredential;
import com.test.warmup.repository.EBSRepository;
import com.test.warmup.repository.ESARepository;
import com.test.warmup.repository.TeamMemberRepository;
import com.test.warmup.repository.UserRepository;

@RestController
public class EsoTestResource {
